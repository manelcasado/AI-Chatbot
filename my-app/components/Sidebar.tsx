      ...
      <ul className="gap-5 flex lg:flex-col">
        <li className="flex-1">
            ...
            >
              ...
              <div className="hidden md:inline"> 
                ...
                <p className="text-sm font-extralight">Create a new chatbot</p>
              </div>
            </Link>
        </li>
        <li className="flex-1">
            ...
            <div className="hidden md:inline"> 
              ...
              <p className="text-sm font-extralight">Edit your chatbots</p>
            </div>
            </Link>
          </li>
        ...
        <li className="flex-1">
            ...
            <div className="hidden md:inline"> 
              ...
              <p className="text-sm font-extralight">Search your chatbots</p>
            </div>
            </Link>
        </li>
      </ul>
